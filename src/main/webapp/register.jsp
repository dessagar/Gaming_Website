            ...
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                try
                {
                	...
                	int c=(int)session.getAttribute("msg");
                	if(c==1)
                	{
                %>
                ...
                <%
                	...
                	{
                 %>	
                 <h3 style="color: red;">Enter valid mobile Number..!!</h3>	
                 <%
                	}
                	else if(c==3)
                	{
                %>	
                <h2 style="color: green;">Registration Successfull..!!</h2>
                <%
                	}
                	else if(c==4)
                	{
                %>
                <h3 style="color: red;">Enter Unique Email ID</h3>	
                <%
                	}
                }catch(Exception ex)
                {
                ...
                <form class="mx-1 mx-md-4" action="registerController" method="post" >
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      <input type="number" id="form3Example4c" name="mobno"  class="form-control" />
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      <input type="password" id="form3Example4cd" name="cpass"  class="form-control" />
              ...
              <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                ...
                <img src="images/logo.jpeg" class="img-fluid" alt="Sample image">
